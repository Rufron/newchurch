				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<li class="menu-item current-menu-item"><a href="{{ url('/events')}}">Events <small>Sunt in culpa</small></a></li>
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                               @foreach ($events as $event )
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5> {{$event->date}}<div></div>{{$event->location}}</h5>
                                        ...
                                        <li>
                                            @foreach($events as $event)
                                                <div class="family">
                                                    ...
                                                    <h3 class="family-name">{{ $event->title}}</h3>
                                                    <hr>
                                                    <p>{{ $event->date}}</p>
                                            @endforeach
                                        </li>
