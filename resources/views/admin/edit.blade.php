            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Events Page</h1>
                        <a href="{{url('admin/events')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-calendar-alt fa-sm text-white-50"></i> Events Page</a>
                    </div> --}}

                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Events Page</h1>
                        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm tooltip">
                          <i class="fas fa-calendar-alt fa-sm text-white-50"></i>
                          <span class="tooltiptext">Click me to return back to the events page</span>
                        </a>
                    </div>
